jQuery.sap.declare("SharedWorkplaceDemo.Component");
jQuery.sap.require("SharedWorkplaceDemo.MyRouter");

sap.ui.core.UIComponent.extend("SharedWorkplaceDemo.Component", {
	metadata: {
		name: "SharedWorkplaceDemo",
		version: "1.0",
		includes: [],
		dependencies: {
		...
		rootView: "SharedWorkplaceDemo.view.App",
		...
		routing: {
			config: {
				routerClass: SharedWorkplaceDemo.MyRouter,
				viewType: "XML",
				viewPath: "SharedWorkplaceDemo.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("SharedWorkplaceDemo");
		...
		if (window.cordova) { //TODO: If running using Cordova without SMP :
